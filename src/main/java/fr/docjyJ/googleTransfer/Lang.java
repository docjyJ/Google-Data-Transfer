...
public class Lang {
    ...
    public static final String ASK_LIKED = "Do you want to transfer the liked videos? " + YES_NO;
    public static final String ASK_DISLIKED = "Do you want to transfer the disliked videos? " + YES_NO;
